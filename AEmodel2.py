...
class AE_model(Model): 
    ...
    def __init__(self):
        ...
        self.p_1 = AveragePooling2D(pool_size=(2, 2), strides=2, padding='valid')  # 池化层
        ...
        self.l_2 = Conv2D(filters=128, kernel_size=1, padding='same',strides=2,kernel_initializer='he_uniform')
        ...
        self.l_3 = Conv2D(filters=256, kernel_size=1, padding='same',strides=2,kernel_initializer='he_uniform')
        ...
        # 加载网络
        self.checkpoint_save_path = "./model_Encoder2/base"
...
class Class_model(Model): 
    ...
    def __init__(self):
        ...
        # 加载网络
        self.checkpoint_save_path = "./model_Encoder2/class"
        if os.path.exists(self.checkpoint_save_path + '.index'):
            print('-------------load the model-----------------')
            self.load_weights(self.checkpoint_save_path)
        else:
